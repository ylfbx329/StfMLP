...
def main(i):
    ...
    configpath = "./v8_test_config.yaml"
    ...
    # -----------------------------------------------------
    resultname = "stfmlp_" + datalist[idx+1][1]
    save_path = os.path.join(logpath, resultname)
    traindata = MyDataset(configs.trainpath, datalist[idx+1], patchrow, patchcol, overlap=overlap)
